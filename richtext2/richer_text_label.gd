...
static var STACK_STATE := preload("res://richtext2/stack_state.gd").new()
...
const DIR_TEXT_EFFECTS := "res://richtext2/text_effects/effects"
const DIR_TEXT_TRANSITIONS := "res://richtext2/text_effects/anims"
